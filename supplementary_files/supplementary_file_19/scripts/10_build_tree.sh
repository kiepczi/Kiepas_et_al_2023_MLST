...
raxml-ng --check --msa ../output/alignments/concatenated/concatenated_alignment_no_gaps.fasta --model ../output/modeltest_ng_output/output.part.bic --prefix ../output/tree/01_check
raxml-ng --parse --msa ../output/tree/01_check.raxml.reduced.phy --model ../output/modeltest_ng_output/output.part.bic --prefix ../output/tree/02_parse
...
raxml-ng --support --tree ../output/tree/03_bootstrap.raxml.bestTree --bs-trees ../output/tree/03_bootstrap.raxml.bootstraps --prefix ../output/tree/04_tbe_mlst --bs-metric tbe
