...
We run:
`python 06_concatenate_alignments.py ../output/alignments/all_sequences/nucleotide ../output/alignments/concatenated/initial_concatenated_alignment.fasta ../output/alignments/concatenated/initial_partition_file.txt 
"""
