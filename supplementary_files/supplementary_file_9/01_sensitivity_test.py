...
MLST_current_STs = pd.read_csv(Path("../supplementary_file_6/output/revised_scheme_genome_ST_info.csv"), dtype=object)

#Data 2: Most recent scheme
scheme = pd.read_csv(Path("../supplementary_file_8/output/revised_scheme/revised_scheme.txt"), dtype=object, sep='\t')
...
MLST_current_output = pd.read_csv(Path("../supplementary_file_4/output/revised_scheme_run/revised_scheme_run.txt"), sep='\t', usecols=['FILE', 'SCHEME', 'ST', '16S', 'atpD', 'gyrB', 'recA', 'rpoB', 'trpB'])
...
print(len(set([_ for _ in no_allele['ST']])))
print(len(set([_ for _ in MLST_current_STs['ST']])))
