...
df_16S = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/blastn_16S.txt").expanduser(),sep='\t', names=header_list)
df_atpD = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/tblastn_atpD.txt").expanduser(),sep='\t', names=header_list)
df_recA = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/tblastn_recA.txt").expanduser(),sep='\t', names=header_list)
df_rpoB = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/tblastn_rpoB.txt").expanduser(),sep='\t', names=header_list)
df_gyrB = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/tblastn_gyrB.txt").expanduser(),sep='\t', names=header_list)
df_trpB = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/BLAST_analysis/blast_output/genome_filtration/tblastn_trpB.txt").expanduser(),sep='\t', names=header_list)
...
if not os.path.exists(Path('~/Desktop/Kiepas_et_al_2023_MLST/data/MLST_scheme_extension/mlst_databases_for_scheme_extension/all_genomes_for_mlst_extension').expanduser()):
    os.makedirs(Path('~/Desktop/Kiepas_et_al_2023_MLST/data/MLST_scheme_extension/mlst_databases_for_scheme_extension/all_genomes_for_mlst_extension').expanduser())

blastn_trpB = []
for _ in genomes:
    for filename in filenames:
        if _ in str(filename):
            copy(filename, Path('~/Desktop/Kiepas_et_al_2023_MLST/data/MLST_scheme_extension/mlst_databases_for_scheme_extension/all_genomes_for_mlst_extension').expanduser())
