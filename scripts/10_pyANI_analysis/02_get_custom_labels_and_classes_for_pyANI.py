...
df = pd.read_csv(Path("~/Desktop/Kiepas_et_al_2023_MLST/data/MLST_scheme_revision/Genomes_ST_info.csv").expanduser())
...
datadir = Path("~/Desktop/Kiepas_et_al_2023_MLST/data/pyani_analysis/").expanduser()
